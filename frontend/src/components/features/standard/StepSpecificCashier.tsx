...
const GooglePayIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" className="w-4 h-4">
    <path d="M12 11.5v1.5h3.5c-.14.87-.94 2.55-3.5 2.55-2.1 0-3.82-1.74-3.82-3.88 0-2.14 1.72-3.88 3.82-3.88 1.2 0 2 .51 2.46.95l1.67-1.61C14.96 7.5 13.6 6.87 12 6.87c-3.42 0-6.2 2.76-6.2 6.13 0 3.37 2.78 6.13 6.2 6.13 3.58 0 5.95-2.51 5.95-6.05 0-.41-.04-.72-.1-1.03H12v-.55z" fill="#4285F4"/>
  </svg>
);
